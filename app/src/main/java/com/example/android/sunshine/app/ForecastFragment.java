...
/**
 * Created by Ionut Gorgos on 7/22/2016.
 */
    ...
    public class FetchWeatherTask extends AsyncTask<Void, Void, Void>{
        ...
        protected Void doInBackground(Void... params) {
            ...
            try {
                ...
                URL url = new URL("http://api.openweathermap.org/data/2.5/forecast/daily?q=Bucharest&mode=json&units=metric&cnt=7&APPID=c510284049522bb2e26736146614f08f");
